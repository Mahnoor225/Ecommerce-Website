        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
          ...
          <div className="flex items-center justify-end">
            <div className="text-sm">
              <a href="#" className="font-medium text-[#FF5252] hover:text-black  ">
          ...
          <div>
            <button
              type="submit"
              className="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md bg-[#FF5252] text-white hover:bg-black focus:outline-none focus:ring-2 focus:ring-offset-2 "
            >
              Login IN
            </button>
          </div>
